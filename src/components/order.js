...
submit.addEventListener("click", (event) => {
    ...
    // const index = window.open("./../public/index.html");
    ...
    inputArray = [orderDate, againstQuote, nameList, quantityList, priceList, discount, otherCosts, gstVatRate, note];
    ...
    let validator = order.validation(orderDate.value, vendorValue, shipToValue, nameArray, quantityArray, priceArray, deliveryMethodValue, paymentTermsValue, gstVatRate.value);
    ...
    if (finalValidator === true) {
        ...
        // const list = index.document.querySelector("#list");
        // test1.makeOrderList(list);
